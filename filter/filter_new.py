...
async def process_symbol(session, symbol, time_interval, param_1, param_2, param_3, comparison_operator_1, comparison_operator_2, logical_operator):
    ...
    if ma_1_value is not None and ma_2_value is not None:
        ...
        # 打印均线的值
        print(
            f"Symbol: {symbol}, MA1: {ma_1_value}, MA2: {ma_2_value}")
...
async def apply_filter_parallel(session, time_interval, param_1, param_2, param_3, comparison_operator_1, comparison_operator_2, logical_operator, symbols):
    tasks = [
        process_symbol(session, symbol, time_interval, param_1, param_2, param_3,
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for i, interval in enumerate(intervals, start=1):
            ...
            if selected_symbols is None:
                selected_symbols = await apply_filter_parallel(session, time_interval, param_1, param_2, param_3, comparison_operator_1, comparison_operator_2, logical_operator, symbols)
            else:
                selected_symbols = await apply_filter_parallel(session, time_interval, param_1, param_2, param_3, comparison_operator_1, comparison_operator_2, logical_operator, selected_symbols)
