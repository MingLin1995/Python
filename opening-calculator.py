...
if LS=="L" :
    ...
    print("建議開倉大小（U）:",Long_Open_U,"\n建議開倉大小（顆數、股數）",Long_Open_Unit) #加密貨幣、美股
    #print("建議開倉大小(金額):",Long_Open_U,"\n建議開倉大小（張數）",Long_Open_Unit/1000) #台股
    ...
    print("建議倉大小（U）:",Short_Open_U,"\n建議開倉大小（顆數、股數）",Short_Open_Unit) #加密貨幣、美股
    #print("建議倉大小（金額）:",Short_Open_U,"\n建議開倉大小（張數）",Short_Open_Unit/1000) #台股